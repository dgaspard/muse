  ...
  properties: {
    ...
    template: {
      containers: [
        {
          name: 'api'
          image: '${containerRegistry.properties.loginServer}/muse-api:latest'
          resources: {
            cpu: json('0.5')
            memory: '1Gi'
          }
  ...
  properties: {
    ...
    template: {
      containers: [
        {
          name: 'worker'
          image: '${containerRegistry.properties.loginServer}/muse-worker:latest'
          resources: {
            cpu: json('0.5')
            memory: '1Gi'
          }
  ...
  properties: {
    ...
    template: {
      containers: [
        {
          name: 'web'
          image: '${containerRegistry.properties.loginServer}/muse-web:latest'
          resources: {
            cpu: json('0.5')
            memory: '1Gi'
          }
